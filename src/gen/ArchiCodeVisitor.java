...
public interface ArchiCodeVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitTypeCastExpr(ArchiCodeParser.TypeCastExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNegExpr(ArchiCodeParser.NegExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPlusExpr(ArchiCodeParser.PlusExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAtomExpr(ArchiCodeParser.AtomExprContext ctx);
	/**
