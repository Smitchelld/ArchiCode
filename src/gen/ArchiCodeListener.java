...
public interface ArchiCodeListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link ArchiCodeParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void enterTypeCastExpr(ArchiCodeParser.TypeCastExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code typeCastExpr}
	 * labeled alternative in {@link ArchiCodeParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void exitTypeCastExpr(ArchiCodeParser.TypeCastExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code negExpr}
	 * labeled alternative in {@link ArchiCodeParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void enterNegExpr(ArchiCodeParser.NegExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code negExpr}
	 * labeled alternative in {@link ArchiCodeParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void exitNegExpr(ArchiCodeParser.NegExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code plusExpr}
	 * labeled alternative in {@link ArchiCodeParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void enterPlusExpr(ArchiCodeParser.PlusExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code plusExpr}
	 * labeled alternative in {@link ArchiCodeParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void exitPlusExpr(ArchiCodeParser.PlusExprContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterAtomExpr(ArchiCodeParser.AtomExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code atomExpr}
	 * labeled alternative in {@link ArchiCodeParser#unaryExpr}.
	 * @param ctx the parse tree
	 */
	void exitAtomExpr(ArchiCodeParser.AtomExprContext ctx);
	/**
